...
public class MinionArmorModel extends BipedModel<AbstractMinionEntity> {
    public MinionArmorModel(float p_i46307_1_) {
        this(p_i46307_1_, 64, 32);
    }

    protected MinionArmorModel(float p_i46308_1_, int p_i46308_2_, int p_i46308_3_) {
