...
public class obsidianMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.OBSIDIAN_MINION.playerHead();
    int armorColor = DyeColor.PURPLE.getColorValue();
    Block setBlock = Blocks.OBSIDIAN;
    Item retItem = Items.OBSIDIAN;
    int minionSpeed = 45 * 20;
    Item MinionItem = ItemRegister.OBSIDIAN_MINION;
    static EntityType<obsidianMinionEntity> typeofMinion = EntityRegister.OBSIDIAN_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static obsidianMinionEntity armorstandentity;

    public obsidianMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
