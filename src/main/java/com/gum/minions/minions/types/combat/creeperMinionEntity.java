...
public class creeperMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.CREEPER_MINION.playerHead();
    int armorColor = DyeColor.GREEN.getColorValue();
    EntityType setEntity = EntityType.CREEPER;
    Item retItem = Items.GUNPOWDER;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.CREEPER_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static creeperMinionEntity armorstandentity;

    public creeperMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
