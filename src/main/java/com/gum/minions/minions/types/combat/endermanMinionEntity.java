...
public class endermanMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.ENDERMAN_MINION.playerHead();
    int armorColor = DyeColor.BLACK.getColorValue();
    EntityType setEntity = EntityType.ENDERMAN;
    Item retItem = Items.ENDER_PEARL;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.ENDERMAN_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static endermanMinionEntity armorstandentity;

    public endermanMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
