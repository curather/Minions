...
public class blazeMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.BLAZE_MINION.playerHead();
    int armorColor = DyeColor.YELLOW.getColorValue();
    EntityType setEntity = EntityType.BLAZE;
    Item retItem = Items.BLAZE_ROD;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.BLAZE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static blazeMinionEntity armorstandentity;

    public blazeMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
