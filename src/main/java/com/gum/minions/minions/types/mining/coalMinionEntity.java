...
public class coalMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.COAL_MINION.playerHead();
    int armorColor = DyeColor.BLACK.getColorValue();
    Block setBlock = Blocks.COAL_ORE;
    Item retItem = Items.COAL;
    int minionSpeed = 15 * 20;
    Item MinionItem = ItemRegister.COAL_MINION;
    static EntityType<coalMinionEntity> typeofMinion = EntityRegister.COAL_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static coalMinionEntity armorstandentity;

    public coalMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
