...
public class diamondMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.DIAMOND_MINION.playerHead();
    int armorColor = DyeColor.CYAN.getColorValue();
    Block setBlock = Blocks.DIAMOND_ORE;
    Item retItem = Items.DIAMOND;
    int minionSpeed = 29 * 20;
    Item MinionItem = ItemRegister.DIAMOND_MINION;
    static EntityType<diamondMinionEntity> typeofMinion = EntityRegister.DIAMOND_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static diamondMinionEntity armorstandentity;

    public diamondMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
