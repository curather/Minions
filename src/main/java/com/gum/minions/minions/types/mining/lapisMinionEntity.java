...
public class lapisMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.LAPIS_MINION.playerHead();
    int armorColor = DyeColor.BLUE.getColorValue();
    Block setBlock = Blocks.LAPIS_ORE;
    Item retItem = Items.LAPIS_LAZULI;
    int minionSpeed = 29 * 20;
    Item MinionItem = ItemRegister.LAPIS_MINION;
    static EntityType<lapisMinionEntity> typeofMinion = EntityRegister.LAPIS_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static lapisMinionEntity armorstandentity;

    public lapisMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
