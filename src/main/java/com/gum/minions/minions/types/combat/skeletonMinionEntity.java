...
public class skeletonMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.SKELETON_MINION.playerHead();
    int armorColor = DyeColor.LIGHT_GRAY.getColorValue();
    EntityType setEntity = EntityType.SKELETON;
    Item retItem = Items.BONE;
    HashMap<Item, Float> bonusItemList = new HashMap<>();
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.SKELETON_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static skeletonMinionEntity armorstandentity;

    public skeletonMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
        super(p_i50225_1_, p_i50225_2_);
        bonusItemList.put(Items.ARROW, 50f);
