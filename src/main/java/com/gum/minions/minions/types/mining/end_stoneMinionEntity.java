...
public class end_stoneMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.END_STONE_MINION.playerHead();
    int armorColor = DyeColor.LIGHT_GRAY.getColorValue();
    Block setBlock = Blocks.END_STONE;
    Item retItem = Items.END_STONE;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.END_STONE_MINION;
    static EntityType<end_stoneMinionEntity> typeofMinion = EntityRegister.END_STONE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static end_stoneMinionEntity armorstandentity;

    public end_stoneMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
