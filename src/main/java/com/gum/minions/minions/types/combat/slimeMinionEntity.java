...
public class slimeMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.SLIME_MINION.playerHead();
    int armorColor = DyeColor.LIME.getColorValue();
    EntityType setEntity = EntityType.SLIME;
    Item retItem = Items.SLIME_BALL;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.SLIME_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static slimeMinionEntity armorstandentity;

    public slimeMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
