...
public class spiderMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.SPIDER_MINION.playerHead();
    int armorColor = DyeColor.BROWN.getColorValue();
    EntityType setEntity = EntityType.SPIDER;
    Item retItem = Items.STRING;
    HashMap<Item, Float> bonusItemList = new HashMap<>();
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.SPIDER_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static spiderMinionEntity armorstandentity;

    public spiderMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
        super(p_i50225_1_, p_i50225_2_);
        bonusItemList.put(Items.SPIDER_EYE, 50f);
