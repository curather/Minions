...
public class emeraldMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.EMERALD_MINION.playerHead();
    int armorColor = DyeColor.LIME.getColorValue();
    Block setBlock = Blocks.EMERALD_ORE;
    Item retItem = Items.EMERALD;
    int minionSpeed = 28 * 20;
    Item MinionItem = ItemRegister.EMERALD_MINION;
    static EntityType<emeraldMinionEntity> typeofMinion = EntityRegister.EMERALD_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static emeraldMinionEntity armorstandentity;

    public emeraldMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
