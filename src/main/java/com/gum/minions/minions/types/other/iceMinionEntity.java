...
public class iceMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.ICE_MINION.playerHead();
    int armorColor = DyeColor.LIGHT_BLUE.getColorValue();
    Block setBlock = Blocks.ICE;
    Item retItem = Items.ICE;
    int minionSpeed = 14 * 20;
    Item MinionItem = ItemRegister.ICE_MINION;
    static EntityType<iceMinionEntity> typeofMinion = EntityRegister.ICE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static iceMinionEntity armorstandentity;

    public iceMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
