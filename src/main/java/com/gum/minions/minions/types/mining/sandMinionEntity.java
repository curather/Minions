...
public class sandMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.SAND_MINION.playerHead();
    int armorColor = DyeColor.YELLOW.getColorValue();
    Block setBlock = Blocks.SAND;
    Item retItem = Items.SAND;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.SAND_MINION;
    static EntityType<sandMinionEntity> typeofMinion = EntityRegister.SAND_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static sandMinionEntity armorstandentity;

    public sandMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
