...
public class netheriteMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.NETHERITE_MINION.playerHead();
    int armorColor = DyeColor.BLACK.getColorValue();
    Block setBlock = Blocks.ANCIENT_DEBRIS;
    Item retItem = Items.NETHERITE_SCRAP;
    int minionSpeed = 60 * 20;
    Item MinionItem = ItemRegister.NETHERITE_MINION;
    static EntityType<netheriteMinionEntity> typeofMinion = EntityRegister.NETHERITE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static netheriteMinionEntity armorstandentity;

    public netheriteMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
