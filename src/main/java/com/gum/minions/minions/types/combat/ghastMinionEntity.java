...
public class ghastMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.GHAST_MINION.playerHead();
    int armorColor = DyeColor.LIGHT_BLUE.getColorValue();
    EntityType setEntity = EntityType.GHAST;
    Item retItem = Items.GHAST_TEAR;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.GHAST_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static ghastMinionEntity armorstandentity;

    public ghastMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
