...
public class spruceMinionEntity extends ForestMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.SPRUCE_MINION.playerHead();
    int armorColor = DyeColor.CYAN.getColorValue();
    Block setBlock = Blocks.SPRUCE_LOG;
    Item retItem = Items.SPRUCE_LOG;
    int minionSpeed = 45 * 20;
    Item MinionItem = ItemRegister.SPRUCE_MINION;
        /*
    DON'T EDIT BELOW HERE
     */
    static spruceMinionEntity armorstandentity;

    public spruceMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
