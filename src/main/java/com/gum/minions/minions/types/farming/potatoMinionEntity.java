...
public class potatoMinionEntity extends FarmingMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.POTATO_MINION.playerHead();
    int armorColor = DyeColor.YELLOW.getColorValue();
    Block setBlock = Blocks.POTATOES;
    Item retItem = Items.POTATO;
    int minionSpeed = 32 * 20;
    Item MinionItem = ItemRegister.POTATO_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static potatoMinionEntity armorstandentity;

    public potatoMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
