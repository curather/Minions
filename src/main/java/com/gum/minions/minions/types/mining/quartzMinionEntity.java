...
public class quartzMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.QUARTZ_MINION.playerHead();
    int armorColor = DyeColor.LIGHT_GRAY.getColorValue();
    Block setBlock = Blocks.NETHER_QUARTZ_ORE;
    Item retItem = Items.QUARTZ;
    int minionSpeed = 22 * 20;
    Item MinionItem = ItemRegister.QUARTZ_MINION;
    static EntityType<quartzMinionEntity> typeofMinion = EntityRegister.QUARTZ_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static quartzMinionEntity armorstandentity;

    public quartzMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
