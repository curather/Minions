...
public class magma_cubeMinionEntity extends CombatMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.MAGMA_CUBE_MINION.playerHead();
    int armorColor = DyeColor.ORANGE.getColorValue();
    EntityType setEntity = EntityType.MAGMA_CUBE;
    Item retItem = Items.MAGMA_CREAM;
    int minionSpeed = 26 * 20;
    Item MinionItem = ItemRegister.MAGMA_CUBE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static magma_cubeMinionEntity armorstandentity;

    public magma_cubeMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
