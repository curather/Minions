...
public class oakMinionEntity extends ForestMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.OAK_MINION.playerHead();
    int armorColor = DyeColor.YELLOW.getColorValue();
    Block setBlock = Blocks.OAK_LOG;
    Item retItem = Items.OAK_LOG;
    int minionSpeed = 45 * 20;
    Item MinionItem = ItemRegister.OAK_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static oakMinionEntity armorstandentity;

    public oakMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
