...
public class carrotMinionEntity extends FarmingMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.CARROT_MINION.playerHead();
    int armorColor = DyeColor.ORANGE.getColorValue();
    Block setBlock = Blocks.CARROTS;
    Item retItem = Items.CARROT;
    int minionSpeed = 20 * 20;
    Item MinionItem = ItemRegister.CARROT_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static carrotMinionEntity armorstandentity;

    public carrotMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
