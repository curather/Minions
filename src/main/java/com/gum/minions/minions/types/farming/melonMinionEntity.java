...
public class melonMinionEntity extends FarmingMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.MELON_MINION.playerHead();
    int armorColor = DyeColor.GREEN.getColorValue();
    Block setBlock = Blocks.MELON;
    Item retItem = Items.MELON;
    int minionSpeed = 24 * 20;
    Item MinionItem = ItemRegister.MELON_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static melonMinionEntity armorstandentity;

    public melonMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
