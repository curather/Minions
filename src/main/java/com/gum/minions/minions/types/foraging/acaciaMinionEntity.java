...
public class acaciaMinionEntity extends ForestMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.ACACIA_MINION.playerHead();
    int armorColor = DyeColor.MAGENTA.getColorValue();
    Block setBlock = Blocks.ACACIA_LOG;
    Item retItem = Items.ACACIA_LOG;
    int minionSpeed = 45 * 20;
    Item MinionItem = ItemRegister.ACACIA_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static acaciaMinionEntity armorstandentity;

    public acaciaMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
