...
public class pumpkinMinionEntity extends FarmingMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.PUMPKIN_MINION.playerHead();
    int armorColor = DyeColor.ORANGE.getColorValue();
    Block setBlock = Blocks.PUMPKIN;
    Item retItem = Items.PUMPKIN;
    int minionSpeed = 32 * 20;
    Item MinionItem = ItemRegister.PUMPKIN_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static pumpkinMinionEntity armorstandentity;

    public pumpkinMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
