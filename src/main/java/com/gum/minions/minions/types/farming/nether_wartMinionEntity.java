...
public class nether_wartMinionEntity extends FarmingMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.NETHER_WART_MINION.playerHead();
    int armorColor = DyeColor.PURPLE.getColorValue();
    Block setBlock = Blocks.NETHER_WART;
    Item retItem = Items.NETHER_WART;
    int minionSpeed = 20 * 20;
    Item MinionItem = ItemRegister.NETHER_WART_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static nether_wartMinionEntity armorstandentity;

    public nether_wartMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
