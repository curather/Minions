...
public class jungleMinionEntity extends ForestMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.JUNGLE_MINION.playerHead();
    int armorColor = DyeColor.LIME.getColorValue();
    Block setBlock = Blocks.JUNGLE_LOG;
    Item retItem = Items.JUNGLE_LOG;
    int minionSpeed = 45 * 20;
    Item MinionItem = ItemRegister.JUNGLE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static jungleMinionEntity armorstandentity;

    public jungleMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
