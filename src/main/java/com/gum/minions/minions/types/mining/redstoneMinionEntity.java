...
public class redstoneMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.REDSTONE_MINION.playerHead();
    int armorColor = DyeColor.RED.getColorValue();
    Block setBlock = Blocks.REDSTONE_ORE;
    Item retItem = Items.REDSTONE;
    int minionSpeed = 29 * 20;
    Item MinionItem = ItemRegister.REDSTONE_MINION;
    static EntityType<redstoneMinionEntity> typeofMinion = EntityRegister.REDSTONE_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static redstoneMinionEntity armorstandentity;

    public redstoneMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
