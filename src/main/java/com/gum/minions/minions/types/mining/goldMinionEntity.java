...
public class goldMinionEntity extends AbstractMinionEntity {
    /*
    CUSTOMIZABLE MINION ATTRIBUTES
    get Textures and ids from https://minecraft-heads.com/
     */
    ItemStack playerHead = MinionSkins.GOLD_MINION.playerHead();
    int armorColor = DyeColor.YELLOW.getColorValue();
    Block setBlock = Blocks.GOLD_ORE;
    Item retItem = Items.GOLD_INGOT;
    int minionSpeed = 22 * 20;
    Item MinionItem = ItemRegister.GOLD_MINION;
    static EntityType<goldMinionEntity> typeofMinion = EntityRegister.GOLD_MINION;
    /*
    DON'T EDIT BELOW HERE
     */
    static goldMinionEntity armorstandentity;

    public goldMinionEntity(EntityType<? extends ArmorStandEntity> p_i50225_1_, World p_i50225_2_) {
